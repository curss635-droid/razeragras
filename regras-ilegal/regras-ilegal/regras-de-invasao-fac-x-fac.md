...
Será considerada **invasão de facção** a presença de **10 ou mais membros** de uma organização criminosa dentro do território de outra facção (QG ou favela) com intenção de ataque ou confronto.

Invasões com **menos de 10 membros são proibidas** e serão consideradas **Anti-RP / Anti-Vida**, salvo exceções descritas neste documento.
...
A facção invasora tem o direito de **resgatar os corpos de seus membros**, impedindo que seja solicitado PD.
...
### Invasões Imediatas (sem autorização da Cúpula)

São permitidas nos seguintes casos:

#### Fuga para QG ou Favela

Quando um jogador entra em seu território durante uma ação ou perseguição.

#### **Recuperação de Veículo**

Quando um jogador entra em QG ou favela para recuperar seu próprio veículo.
...
Quando alguém dispara **de dentro do QG ou favela para fora do território**.
...
Devem ser solicitadas antecipadamente via RP.
...
Caso um veículo seja encontrado dentro de território inimigo, o dono poderá tentar recuperá-lo.
...
Se um jogador entrar no território de uma facção durante uma perseguição ou ação, a invasão imediata será liberada.
...
Caso um jogador seja **alvejado de dentro para fora de um território**, a invasão imediata será permitida.
...
### Solicitação de Envio ao Purgatório
...
Em invasões com mais de **10 participantes**, será permitido solicitar o envio de **apenas 2 a 3 personagens** ao Purgatório.
...
Após cumprir sua Sentença Divina, o personagem será liberado do Purgatório e poderá retornar normalmente às suas atividades, mantendo todos os seus bens, dinheiro, itens, veículos e progresso exatamente como estavam antes da punição.
