...
É proibido sair da cidade durante uma ação. O jogador deve aguardar a conclusão da situação antes de desconectar.
...
É proibido utilizar informações externas ao roleplay para obter vantagem dentro do jogo.
...
É proibido matar pessoas sem um motivo válido dentro do roleplay, mesmo que você esteja armado.
...
Power Gaming ocorre quando o jogador realiza **ações irreais ou impossíveis dentro do RP**.
...
É proibido utilizar veículos como arma com intenção de matar.
...
É proibido qualquer tipo de corrupção dentro da cidade.
...
É proibido utilizar qualquer software ou modificação que altere o funcionamento do jogo para obter vantagem.
...
É proibido manipular situações para criar ações forçadas dentro do roleplay.
...
É proibido tomar atitudes que comprometam o andamento ou a fluidez do roleplay.
...
Dark RP envolve conteúdos ofensivos ou extremamente pesados dentro do roleplay.
