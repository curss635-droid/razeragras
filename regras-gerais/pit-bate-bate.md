...
1. O uso de veículos para causar danos intencionais, capotamentos ou colisões proposais está totalmente proibido dentro da cidade.

> A prática conhecida como “bate-bate” será considerada PowerGaming (PG) e Vehicle Deathmatch (VDM).
...
> **Atenção**
>
> **ATENÇÃO:** Justificativas como “foi o vento”, “perdi o controle” ou similares não serão aceitas caso fique evidente a intenção da colisão.

### IDENTIFICAÇÃO DE JOGADORES

> **Informação**
>
> **INFORMAÇÃO:** É permitido utilizar o comando CTRL dentro do veículo para visualizar o ID de jogadores que estejam realizando colisões abusivas ou tentando causar capotamentos.
...
### REVERSÃO DE PUNIÇÕES

> **Sucesso**
>
> **REVISÃO:** Caso o jogador considere a punição injusta, poderá solicitar revisão apresentando provas válidas.

> **Informação**
>
> • Abra um ticket de reversão de banimento na **Ouvidoria Meta City**
>
> • Lembrando que a staff assume controle da denúncia apenas via Ouvidoria, Call de Suporte não será trata denúncias, Apenas para sanar dúvidas
>
> • Caso necessário, a situação poderá ser revisada diretamente pelo CEO do servidor
>
> Ao ultilizar o CTRL você consegue localizar os ID.
