...
4. **Regras para Situações de Fuga Limpa**\
   Durante uma _Fuga Limpa_, é **estritamente proibido** o uso do **Código 5** no veículo do indivíduo em fuga. Caso seja identificado o uso indevido desse procedimento, o policial envolvido será **punido conforme as regras estabelecidas pela cidade**.\
   \
   A _Fuga Limpa_ deve prosseguir até que o veículo do suspeito esteja **completamente danificado (100%)**. Se o carro **capotar** ou tiver os **pneus furados**, os policiais devem **manter a perseguição normalmente**, sem realizar abordagem forçada.\
